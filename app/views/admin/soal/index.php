<div class="container-fluid">
        ...
        <h1 class="h3 mb-0 text-gray-800">Tryout</h1>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="mb-4">
                <a class="right btn btn-primary" data-toggle="modal" data-target="#addModal">Tambah Tryout</a> 
            </div>
            ...
            <table class="table table-bordered  table-responsive-sm table-striped rounded" id="tableData">
                <thead>
                    <tr class="">
                        ...
                        <th>Judul</th> 
                        <th>Waktu</th>
                        <th width="200px">Passing Grade</th>
                        <th width="200px">Total Nilai</th>
                        <th>Status</th> 
                        <th>Opsi</th>
                    </tr>
                </thead>
      ...
      <div class="modal-body">
        <form id="formAdd">
            <div class="row">
                ...
                <div class="col-sm-6 form-group">
                    <label>Pembahasan</label>
                    <input value="exam" required type="hidden" class="form-control" id="typeAdd" name="type">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" >Edit Tryout <span class="dataName"></span></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="formEdit">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 form-group">
                    <label>Pembahasan</label>
                    <input value="exam" required type="hidden" class="form-control" id="typeEdit" name="type">
                    <textarea required type="text" class="form-control" id="descriptionEdit" name="description"></textarea>
                </div>
                <div class="col-sm-6 form-group">
                    <label>TWK</label>
                    <input required type="number" class="form-control" id="pg_twkEdit" name="pg_twk">
                </div>
                <div class="col-sm-6 form-group">
                    <label>TIU</label>
                    <input required type="number" class="form-control" id="pg_tiuEdit" name="pg_tiu">
                </div>
                <div class="col-sm-6 form-group">
                    <label>TKP</label>
                    <input required type="number" class="form-control" id="pg_tkpEdit" name="pg_tkp">
                </div>
...
<div class="modal fade" id="statusModal" tabindex="-1" role="dialog" aria-labelledby="statusModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form id="formStatus">
            <h5 class="modal-title mb-4 text-center" >Ubah Status Tryout <span class="dataName"></span> ?</h5>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center w-100" >Hapus Tryout <span class="dataName"></span> ?</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
