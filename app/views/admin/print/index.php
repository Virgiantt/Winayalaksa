...
<body style="font-size: 12px">
    ...
    <p align="center"> 
        <table width="100%">
            <tr>
                <td align="center">
                    <span style="font-size: 18px;font-weight: bold;">Hasil Tryout Seleksi Kemampuan Dasar</span>
                </td>
            </tr>    
        </table>
    </p>
    ...
    <p>
        <table>
            ...
            <tr>
                <th align="left">Passing Grade TKP</th>
                <td>:</td>
                <td><?= $question['pg_tkp'] ?></td>
            </tr>
            <tr>
                <th align="left">Passing Grade TWK</th>
                <td>:</td>
                <td><?= $question['pg_twk'] ?></td>
            </tr>
            <tr>
                <th align="left">Passing Grade TIU</th>
                <td>:</td>
        ...
        <table style="border: 1px solid black;border-collapse: collapse;font-size: 11px" width="100%">
            ...
            <?php foreach ($answer as $i => $val): ?>
                <tr style="margin: 5px">
                    ...
                    <td align="center" style="border: 1px solid black;padding-left: 5px;"><?= $val['count_point_twk'] ?></td>
                    <td align="center" style="border: 1px solid black;padding-left: 5px;"><?= $val['count_point_tiu'] ?></td>
                    <td align="center" style="border: 1px solid black;padding-left: 5px;"><?= $val['count_point_tkp'] ?></td>
                    <td align="center" style="border: 1px solid black;padding-left: 5px;"><?= $val['count_point'] ?></td>
                    <td align="center" style="border: 1px solid black;padding-left: 5px;"><?= $val['kelulusan'] ?></td>
                </tr>
            <?php endforeach ?>
